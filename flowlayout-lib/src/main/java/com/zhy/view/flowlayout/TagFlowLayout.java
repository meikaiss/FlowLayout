...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private void changeAdapter() {
        ...
        tvMoreOrShrink = adapter.getMoreView(this);
        if (tvMoreOrShrink != null) {
            tvMoreOrShrinkContainer = new TagView(getContext());
            tvMoreOrShrink.setDuplicateParentStateEnabled(true);
            if (tvMoreOrShrink.getLayoutParams() != null) {
                tvMoreOrShrinkContainer.setLayoutParams(tvMoreOrShrink.getLayoutParams());
            } else {
                ...
                lp.setMargins(dip2px(getContext(), 5),
                        ...
                        dip2px(getContext(), 5),
                        dip2px(getContext(), 5));
                tvMoreOrShrinkContainer.setLayoutParams(lp);
            }

            tvMoreOrShrinkContainer.addView(tvMoreOrShrink);
            addView(tvMoreOrShrinkContainer);
        }
    ...
    public boolean performClick() {
        ...
        if (pos == 0) {
            if (child != null) {
                if (mode == Mode.EXPAND) {
                    mode = Mode.SHRINK;
                    tvMoreOrShrink.setText("更多");
                } else {
                    mode = Mode.EXPAND;
                    tvMoreOrShrink.setText("收起");
                }
                this.requestLayout();
                this.invalidate();
            }
            ...
            if (child != null) {
                ...
                if (mOnTagClickListener != null) {
                    return mOnTagClickListener.onTagClick(child.getTagView(), pos - 1, this);// 减1 是因为 第一个 是 "更多、收起"View
                }
            }
        }
